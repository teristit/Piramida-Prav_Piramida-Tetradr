...
# 1. Создать производный класс Prav_Piramida (правильная треугольная пирамида). Определить в классе наследнике:
...
# 1. Создать производный класс Tetradr (тетраэдр). Определить в классе наследнике:
